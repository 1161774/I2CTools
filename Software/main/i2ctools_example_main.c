...
static void initialise_GPIO()
{
	...
	io_conf.pin_bit_mask = (1ULL << GPIO_INPUT_I2CDetect);
	...
	gpio_set_intr_type(GPIO_INPUT_I2CDetect, GPIO_INTR_POSEDGE);
	...
	gpio_isr_handler_add(GPIO_INPUT_I2CDetect, gpio_isr_handler, (void*) GPIO_INPUT_I2CDetect);
